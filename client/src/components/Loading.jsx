...
const StudentMarketplaceLanding = () => {
  ...
  const features = [
    {
      ...
      description: "University email enforcement and academic profiles for trusted transactions",
      color: "from-blue-500 to-cyan-500"
    },
    {
      icon: Search,
      title: "Smart Listings & Discovery",
      description: "AI-powered search with flexible pricing and visibility controls",
      color: "from-purple-500 to-pink-500"
    },
    {
      icon: MessageCircle,
      title: "Real-Time Communication",
      description: "Instant messaging with image sharing for seamless negotiations",
  ...
  const aiFeatures = [
    ...
    },
    {
      icon: MessageCircle,
      title: "Smart Chatbot",
      description: "Natural language search assistance for finding perfect items"
    },
    {
      icon: Camera,
      title: "Condition Estimator",
      description: "Image AI automatically estimates item condition from photos"
    },
    {
      icon: Eye,
      title: "Visual Search",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white overflow-hidden">
        ...
        <div className="container mx-auto text-center">
          ...
          <FloatingCard delay={1} className="mb-8">
            <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
              A secure, AI-powered marketplace exclusively for university students. 
              Buy, sell, and connect with verified peers in your campus community.
            </p>
          </FloatingCard>
      ...
      {/* AI Features Section */}
      <section id="ai" className="relative z-10 py-20 px-6 bg-gradient-to-r from-purple-900/20 to-cyan-900/20">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">
              Cutting-edge artificial intelligence makes trading smarter and safer
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "Register with your university email and create your trusted student profile",
                icon: Shield
              },
              {
                step: "02", 
                title: "List or Search",
                description: "Post items for sale or browse AI-curated listings from verified students",
                icon: Search
              },
              {
                step: "03",
                title: "Connect & Trade",
                description: "Chat securely and meet safely on campus using our interactive maps",
                icon: CheckCircle
              }
            ].map((item, index) => (
      ...
      {/* Testimonials */}
      <section id="testimonials" className="relative z-10 py-20 px-6 bg-gradient-to-r from-slate-900/50 to-purple-900/50">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-6xl font-bold mb-6">
          ...
          <FloatingCard>
            <div className="bg-gradient-to-r from-purple-600/20 to-cyan-600/20 backdrop-blur-md border border-purple-500/30 rounded-3xl p-12 max-w-4xl mx-auto">
              ...
              <p className="text-xl text-gray-400 mb-8 max-w-2xl mx-auto">
                Join thousands of students already trading safely and smartly on CampusMarket
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
      ...
      <footer className="relative z-10 bg-black/40 backdrop-blur-md border-t border-white/10 py-12 px-6">
        <div className="container mx-auto">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400 mb-4">
                The future of student commerce, powered by AI and built for safety.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li><a href="#" className="hover:text-purple-400 transition-colors">University Partners</a></li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li><a href="#" className="hover:text-purple-400 transition-colors">Report Issue</a></li>
          ...
          <div className="border-t border-white/10 mt-12 pt-8 text-center text-gray-400">
            <p>&copy; 2025 CampusMarket. Built for students, by students. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
