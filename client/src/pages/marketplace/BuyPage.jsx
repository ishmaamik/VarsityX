      ...
      try {
        ...
        const response = await axios.get('http://localhost:5000/marketplace', {
          params: {
            ...
            university: filterUniversity === 'University' ? undefined : filterUniversity,
            condition: filterCondition === 'Condition' ? undefined : filterCondition,
            minPrice: filterPriceMin || undefined,
            maxPrice: filterPriceMax || undefined,
            sortBy
          },
